...
var RandomGenerator = {
	...
	/*
		...
		Metoden returnerar en array inneh?landes utslumpade tal mellan 1 och (rows*cols)/2. Varje tal representeras tv?
		g?ger och motsvarar s?edes en spelbricka.

		I en 4*4 matris kan Arrayen t.ex. se ut s?h?:
		[1,2,6,8,6,2,5,3,1,3,7,5,8,4,4,7]

		I en 2*4 matris kan Arrayen t.ex. se ut s?h?:
		[3,4,4,1,2,1,2,3]
	*/
